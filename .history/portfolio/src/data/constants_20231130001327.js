...
export const Bio = {
  ...
  export const experiences = [
    ...
    
    {
      ...
      desc: "sigeduced website load times by 67%, leading to a 20% increase in user engagement, developed algorithms for efficient query routing, enhanced team collaboration and problem-solving, and embraced new technologies, contributing to the startup's recognition as the best in Kerala for three years.",
      skills: [
        "ReactJS",
        "Redux",
        "NodeJs",
    ...
    },
    {
      id: 2,
      img: ieee,
      role: "Hybridized Statistical and Machine Learning Algorithms for Enhanced Stock Market Price Prediction",
  ...
  export const projects = [
    ...
    },
    {
      ...
      description:
        "puppyMatch is a website to find friends for dogs",
      image:pp,
      tags: [
        "HTML",
        "CSS",
